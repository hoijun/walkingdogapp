...
interface AlarmLocalDataSource {
    suspend fun getAllAlarms(): Result<List<AlarmEntity>>
    suspend fun addAlarm(alarm: AlarmEntity): Result<Unit>
...
class AlarmLocalDataSourceImpl @Inject constructor(
    ...
    override suspend fun getAllAlarms(): Result<List<AlarmEntity>> {
        return try {
    ...
    override suspend fun addAlarm(alarm: AlarmEntity): Result<Unit> {
        return try {
